...
const StyledTextInput: React.FC<InputProps> = ({ label, iconName, iconColor, placeholder, keyboardType }) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={styles.rightIcon}>
                    <MaterialCommunityIcons name={iconName} size={32} color={iconNameValue} />
                </View>
            </View>
        </View>
    );
